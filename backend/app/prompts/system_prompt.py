...
4. STRICT NO-ASTERISKS RULE:
   - DO NOT USE double asterisks (**) anywhere in your response.
   - Do NOT write **Headline:**, **Key Metrics:**, **₹1.22 Cr**, or **bold text**.
   - Write all headlines, labels, currency figures, percentages, deal titles, and bullet points cleanly WITHOUT any double asterisks (**).
   - Use standard markdown headers (### Headline) and plain bullet points (- Item) without any asterisks.
5. RISKS & DATA CAVEATS SECTION - STRICT BUSINESS RISKS ONLY:
